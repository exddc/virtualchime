...
constexpr vc::config::Field<ChimeConfig> kConfigFields[] = {
    ...
    {"mqtt_username",
     vc::config::parse_string<ChimeConfig, &ChimeConfig::mqtt_username>, false},
    {"mqtt_password",
     vc::config::parse_string<ChimeConfig, &ChimeConfig::mqtt_password>, false},
    {"mqtt_tls_enabled",
     vc::config::parse_bool<ChimeConfig, &ChimeConfig::mqtt_tls_enabled>, false},
    {"mqtt_tls_validate_certificate",
     vc::config::parse_bool<ChimeConfig,
                            &ChimeConfig::mqtt_tls_validate_certificate>,
     false},
    {"mqtt_tls_ca_file",
     vc::config::parse_string<ChimeConfig, &ChimeConfig::mqtt_tls_ca_file>,
     false},
    {"mqtt_tls_cert_file",
     vc::config::parse_string<ChimeConfig, &ChimeConfig::mqtt_tls_cert_file>,
     false},
    {"mqtt_tls_key_file",
     vc::config::parse_string<ChimeConfig, &ChimeConfig::mqtt_tls_key_file>,
     false},
    ...
    {"volume_bell",
     vc::config::parse_int<ChimeConfig, &ChimeConfig::volume_bell, 0, 100>,
     false},
    {"volume_notifications",
     vc::config::parse_int<ChimeConfig, &ChimeConfig::volume_notifications, 0,
                           100>,
     false},
    {"volume_other",
     vc::config::parse_int<ChimeConfig, &ChimeConfig::volume_other, 0, 100>,
     false},
    {"audio_enabled",
